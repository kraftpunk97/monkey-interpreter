//
// Created by kxg220013 on 12/11/2023.
//
...
stmt_t* parser_parse_stmt_expr(parser_t* parser) {
...
stmt_t* parser_parse_stmt_block(parser_t* parser) {
...
*/
expr_t* parser_parse_expr(parser_t* parser, precedence_t precedence) {
...
expr_t* parser_parse_expr_identifier(parser_t* parser) {
    return expr_identifier_create(parser->current_token);
}


expr_t* parser_parse_expr_number(parser_t* parser) {
...
*/
expr_t* parser_parse_expr_infix(parser_t* parser, expr_t* left_expr) {
    token_t curr_token = token_dup(parser->current_token);
    char* operator = curr_token.literal;
...
expr_t* parser_parse_expr_group(parser_t* parser) {
    parser_next_token(parser);
...
expr_t* parser_parse_expr_if(parser_t* parser) {
...
expr_t* parser_parse_expr_fn_def(parser_t* parser) {
    token_t token = token_dup(parser->current_token);
...
bool parser_current_token_is(parser_t* p, tokentype_t type) {
    return p->current_token.type == type;
}


bool parser_peek_token_is(parser_t* p, tokentype_t type) {
    return p->peek_token.type == type;
}


bool parser_expect_peek(parser_t* p, tokentype_t type) {
